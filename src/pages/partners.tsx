...
import ortmLogo from "@assets/EFK_Images/logo_ortm.png";
import cheriflaLogo from "@assets/EFK_Images/logo_cheriflatv.jpg";
import renouveauLogo from "@assets/EFK_Images/logo_renouveautv.jpeg";
import kita24Logo from "@assets/EFK_Images/logo_kita24.jpeg";
      ...
      <div className="bg-background min-h-screen py-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <Badge
              variant="outline"
              className="mb-4 border-primary/20 text-orange-600 tracking-widest uppercase"
            >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              La réussite du centenaire repose sur l'engagement de nos
              institutions et le soutien indéfectible de nos parrains. Merci à
              tous ceux qui rendent cet événement possible.
            </p>
          </div>
            ...
            <div className="relative group">
              ...
              <Card className="relative bg-card border-border shadow-xl rounded-3xl overflow-hidden h-full">
                ...
                <div className="px-8 pb-8 -mt-16 flex flex-col items-center text-center">
                  ...
                  <Badge className="bg-accent text-white mb-3">
                    Parrain du Centenaire
                  </Badge>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed italic">
                    "Originaire de Kourouninkoto, je dois mon parcours aux bases
                    solides reçues dans cette école. C'est un honneur de
                    parrainer ce centenaire."
                  </p>
                </div>
              </Card>
            </div>
            ...
            <div className="relative group">
              ...
              <Card className="relative bg-card border-border shadow-xl rounded-3xl overflow-hidden h-full">
                ...
                <div className="px-8 pb-8 -mt-16 flex flex-col items-center text-center">
                  ...
                  <Badge className="bg-secondary text-primary mb-3">
                    Marraine du Centenaire
                  </Badge>
                  <h2 className="text-2xl font-serif font-bold text-primary mb-1">
                    Mme Fatoumata Batouly
                  </h2>
                  <p className="text-muted-foreground font-medium mb-4 flex items-center justify-center gap-2">
                    <Heart className="w-4 h-4" /> Figure Communautaire
                  </p>
                  <p className="text-sm text-muted-foreground leading-relaxed italic">
                    "L'éducation de nos enfants est la clé de notre avenir. Je
                    m'engage pour que l'EFK continue de briller pour les 100
                    prochaines années."
                  </p>
                </div>
              </Card>
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="bg-white p-8 rounded-xl border border-border shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center group"
                >
                  ...
                  <Badge
                    variant="outline"
                    className="mt-3 border-gray-200 text-gray-500 text-xs"
                  >
                    Partenaire Officiel
                  </Badge>
                </div>
          ...
          <div className="mb-24">
            ...
            <div className="relative overflow-hidden bg-white rounded-2xl p-8 border border-border">
              <div className="overflow-x-auto">
                <div className="flex gap-12 min-w-min pb-4">
                  {[
                    { logo: ortmLogo, name: "ORTM" },
                    { logo: cheriflaLogo, name: "Cherifla TV" },
                    { logo: renouveauLogo, name: "Renouveau TV" },
                    { logo: kita24Logo, name: "Kita 24" },
                  ].map((sponsor, i) => (
                    <div
                      key={i}
          ...
          <div className="bg-primary rounded-3xl p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="text-primary-foreground/80 mb-8 text-lg">
                Vous souhaitez associer votre image à cet événement historique
                ou soutenir nos actions éducatives ?
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/don">
                  <Button
                    size="lg"
                    className="bg-accent hover:bg-accent/90 text-white font-bold py-6 px-8 text-lg shadow-xl"
                  >
                ...
                <Link href="/contact">
                  <Button
                    size="lg"
                    variant="outline"
                    className="bg-transparent border-white/30 text-white hover:bg-white hover:text-primary font-bold py-6 px-8 text-lg"
                  >
