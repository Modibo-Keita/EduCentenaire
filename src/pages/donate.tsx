          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
                Vos dons permettent de financer la rénovation des salles de
                classe, l'achat de matériel pédagogique et les bourses pour les
                élèves méritants.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <Card className="bg-primary/5 border-primary/20">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Réhabilitation des bâtiments historiques de 1925
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-accent/5 border-accent/20">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Soutien scolaire aux élèves issus de familles modestes
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-secondary/20 border-secondary/40">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Équipement de la nouvelle salle informatique
                  </p>
                </CardContent>
              </Card>
            </div>

            {/* Section des donateurs */}
              ...
              <CardContent className="p-8">
                <form onSubmit={handleDonate} className="space-y-8">
                    ...
                    >
                      {["1000", "2000", "5000", "10000"].map((val) => (
                        <div key={val}>
                          ...
                          <Label
                            htmlFor={`amount-${val}`}
                            className="flex flex-col items-center justify-center rounded-lg border-2 border-muted bg-transparent p-4 hover:bg-primary hover:text-accent-foreground peer-data-[state=checked]:border-accent peer-data-[state=checked]:bg-accent/10 peer-data-[state=checked]:text-accent cursor-pointer transition-all"
                          >
                  ...
                  <p className="text-xs text-center text-muted-foreground mt-4">
                    Paiement 100% sécurisé. Un reçu fiscal vous sera envoyé par
                    email.
                  </p>
                </form>
              </CardContent>
