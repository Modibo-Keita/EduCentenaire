  ...
  const testimonials = [
    {
      ...
      role: "Avocat au barreau malien",
      image: testimonial1,
      quote:
        "L'Ecole Fondamentale de Kourouninkoto a été le fondement de tout ce que j'ai accompli. C'est ici que j'ai appris non seulement à lire et écrire, mais aussi les valeurs de rigueur et de service à la communauté qui ne m'ont jamais quitté.",
    },
    {
      name: "Madeira Keita",
      promotion: "Première promotion",
    ...
    {
      name: "Harimakan Keita",
      promotion: "Promotion - 1966",
      role: "Homme politique",
      image: testimonial4,
      quote:
        "L'école a toujours su évoluer avec son temps. C'est la bibliothèque de l'EFK qui m'a ouvert au monde. Fêter ce centenaire, c'est célébrer un siècle d'opportunités offertes à la jeunesse rurale.",
    },
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Découvrez les parcours inspirants de ceux qui ont grandi et appris
              entre les murs de notre école. Leurs histoires sont notre plus
              grande fierté.
            </p>
          </div>
          ...
          <div className="mt-24 bg-secondary/10 rounded-3xl p-8 md:p-12 text-center border border-secondary/30">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              Votre histoire fait partie de la nôtre. Partagez vos souvenirs,
              photos de classe ou anecdotes pour enrichir la mémoire collective
              du centenaire.
            </p>
